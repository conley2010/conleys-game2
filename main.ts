...
let startscreen = "welcome to Bobers great escape!"
...
let mySprite = sprites.create(assets.image`supersprite`, attack)
...
scaling.scale3x(assets.image`supersprite`)
mySprite.setImage(assets.image`supersprite`)

forever(function() {
 
    music.playMelody("E F G D C c B G F E D C C E F G D D ", 90)
    music.playMelody("D D G F E C C D E F G B C C D G F E", 120)
